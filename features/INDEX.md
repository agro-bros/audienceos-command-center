...
| multi-org-roles | 📝 Specced | [VISION](../docs/01-product/VISION.md) / [SCOPE](../docs/01-product/SCOPE.md) / [RISKS](../docs/05-planning/RISK-REGISTER.md) / [PRD](../docs/01-product/PRD-MULTI-ORG-ROLES.md) | RBAC system: Owner/Admin/Manager/Member hierarchy. 8 resources × 3 actions. MVP: 22 DUs (~6 sessions). **D-1 SpecKit complete 2026-01-08**: PRD (18 user stories), Data Model (5 tables), API Contracts (15 endpoints), Tech Stack. Ready for implementation. |
