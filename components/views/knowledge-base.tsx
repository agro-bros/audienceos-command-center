...
// Acme Marketing Agency - Knowledge Base Documents
const mockDocuments: Document[] = [
  ...
  {
    id: "doc-3",
    name: "Evergreen Dental Brand Kit",
    type: "pdf",
    category: "creative",
    ...
    shared: true,
    starred: false,
    clientName: "Evergreen Dental",
    tags: ["brand", "dental", "healthcare"],
    viewCount: 156,
    downloadCount: 45,
  },
  {
  ...
  {
    id: "doc-8",
    name: "Coastal Properties Campaign Assets",
    type: "folder",
    category: "creative",
